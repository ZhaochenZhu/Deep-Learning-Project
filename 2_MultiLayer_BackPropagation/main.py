...
def main(args):
    ...
    if (args.experiment == 'test_gradients'):  #2b
        ...
        configFile = "config_2f_i.yaml" # Create a config file for 2f-i and change None to the config file name
    elif (args.experiment == 'test_hidden_layers'):  #2f-ii
        configFile = "config_2f_ii.yaml" # Create a config file for 2b and change None to the config file name
    ...
    print(f"momentum_gamma: {config['momentum_gamma']}")

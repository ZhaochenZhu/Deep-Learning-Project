...
def get_datasets(config_data):
    ...
    return coco, coco_test, vocabulary, train_data_loader, val_data_loader, test_data_loader#I changed this to test functions, remember to change back
...
#     ann_ids = [coco_obj.imgToAnns[img_ids[i]][j]['id'] for i in range(0, len(img_ids)) for j in
#                 range(0, 1)] #change this for smaller set 

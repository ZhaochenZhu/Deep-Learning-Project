...
def params():
    ...
    parser.add_argument("--task", default="baseline", type=str,\
                help="baseline is fine-tuning bert for classification;\n\
                      ...
                      #choices=['baseline','tune','supcon', 'baselinedraw', 'supcondraw'])
    parser.add_argument("--temperature", default=0.7, type=float, 
                help="temperature parameter for contrastive loss")
    parser.add_argument("--supconloss", default='true', type=str, help="whether to use simCSE loss or SupCon loss")
